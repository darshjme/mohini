//! Request/response types for the Mohini API.
...
pub struct SpawnRequest {
    ...
    /// Template name from `~/.mohini/agents/{template}/agent.toml`.
...
pub struct SetModeRequest {
    pub mode: mohini_types::agent::AgentMode,
}
...
/// Request to install a skill from SkillHub.
#[derive(Debug, Deserialize)]
pub struct SkillHubInstallRequest {
    /// SkillHub skill slug (e.g., "github-helper").
    pub slug: String,
}
