...
const ETAG: &str = concat!("\"mohini-", env!("CARGO_PKG_VERSION"), "\"");
...
/// GET /logo.png — Serve the Mohini logo.
...
/// GET /favicon.ico — Serve the Mohini favicon.
...
/// GET / — Serve the Mohini Dashboard single-page application.
///
...
/// The embedded HTML/CSS/JS for the Mohini Dashboard.
///
