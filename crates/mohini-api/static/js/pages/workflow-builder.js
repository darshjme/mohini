// Mohini Visual Workflow Builder — Drag-and-drop workflow designer
'use strict';
...
function workflowBuilder() {
  return {
    ...
    async init() {
      ...
      try {
        var list = await MohiniAPI.get('/api/agents');
    ...
    async saveWorkflow() {
      ...
      try {
        await MohiniAPI.post('/api/workflows', {
          name: this.workflowName || 'untitled',
          description: this.workflowDescription || '',
          steps: steps
        });
        MohiniToast.success('Workflow saved!');
