//! Configuration loading from `~/.mohini/config.toml` with defaults.
//!
...
///
/// Respects `MOHINI_HOME` env var (e.g. `MOHINI_HOME=/opt/mohini`).
pub fn default_config_path() -> PathBuf {
    mohini_home().join("config.toml")
}

/// Get the Mohini home directory.
///
/// Priority: `MOHINI_HOME` env var > `~/.mohini`.
pub fn mohini_home() -> PathBuf {
