//! SkillHub marketplace client — install skills from the registry.
//!
...
/// SkillHub registry configuration.
#[derive(Debug, Clone)]
...
impl Default for MarketplaceConfig {
    fn default() -> Self {
        Self {
            ...
            github_org: "mohini-skills".to_string(),
        }
    }
}

/// Client for the SkillHub marketplace.
...
mod tests {
    ...
    fn test_default_config() {
        ...
        assert_eq!(config.github_org, "mohini-skills");
    }

    #[test]
    fn test_client_creation() {
        let client = MarketplaceClient::new(MarketplaceConfig::default());
        assert_eq!(client.config.github_org, "mohini-skills");
    }
}
