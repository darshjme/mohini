//! Shared error types for the Mohini system.

use thiserror::Error;

/// Top-level error type for the Mohini system.
#[derive(Error, Debug)]
pub enum MohiniError {
...
/// Alias for Result with MohiniError.
pub type MohiniResult<T> = Result<T, MohiniError>;
