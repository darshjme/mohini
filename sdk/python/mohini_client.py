"""
Mohini Python Client — REST API client for controlling Mohini remotely.

Usage:

    from mohini_client import Mohini

    client = Mohini("http://localhost:3000")
...
Note: This is the REST API *client* library.
      For writing Python agents that run inside Mohini, see mohini_sdk.py instead.
"""
...
class _Resource:
    def __init__(self, client: "Mohini"):
        self._c = client


class Mohini:
    """Mohini REST API client. Zero dependencies — uses only stdlib urllib."""
    ...
    def _request(self, method: str, path: str, body: Any = None) -> Any:
        ...
        try:
            ...
            raise MohiniError(f"HTTP {e.code}: {body_text}", e.code, body_text) from e
